...
export function BestSellerCard({ product }: BestSellerCardProps) {
  ...
  return (
    <a
      href={`/produtos/${id}`}
      className="group/card flex h-full flex-col overflow-hidden rounded-2xl border border-cream/12 bg-white/4 transition-colors duration-500 hover:border-gold/45 focus-visible:border-gold focus-visible:ring-2 focus-visible:ring-gold/60 focus-visible:outline-none"
    >
