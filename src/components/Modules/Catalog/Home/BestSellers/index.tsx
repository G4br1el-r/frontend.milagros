...
export function BestSellers() {
  return (
    <section
      id="best-sellers"
      className="relative z-10 w-full scroll-mt-24 bg-primary-darkest"
    >
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full border border-cream/20 px-4 py-1.5">
            <Flame
              ...
              strokeWidth={2}
            />
            <span className="text-[10px] font-medium tracking-[0.3em] text-cream/90 uppercase">
              Devoção da casa
            </span>
          </span>

          <h2 className="font-display text-3xl leading-tight text-balance text-cream sm:text-4xl">
            Mais vendidos
          </h2>

          <p className="max-w-lg text-balance text-sm leading-relaxed text-cream/60">
            As peças que saem primeiro das prateleiras — escolhidas por
            paróquias, capelas e devotos de todo o país.
          </p>
        </FadeIn>
