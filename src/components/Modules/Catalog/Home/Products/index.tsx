  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[1920px] py-20 sm:py-24 lg:py-28">
        ...
        <div className="mx-auto mb-4 flex w-full max-w-page flex-wrap items-center justify-between gap-x-4 gap-y-3 px-5 sm:px-8">
        ...
        <div className="mx-auto flex w-full max-w-page items-start gap-4 px-5 sm:px-8 xl:gap-5">
