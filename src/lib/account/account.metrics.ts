...
/**
 * Métricas calculadas a partir da lista de pedidos do cliente — a API não
 * tem um endpoint de resumo próprio (ver API.md), então isto roda no client
 * sobre os pedidos já carregados.
 */
