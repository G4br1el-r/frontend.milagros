...
/** Erro da API preservando status e detalhe, para nao mascarar falha do backend. */
...
/** Extrai a mensagem util de ProblemDetails, { mensagem } ou { message }. */
...
/** Lanca CustomerNotFoundError no 404 para o fluxo cair no cadastro. */
