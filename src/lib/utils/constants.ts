...
export type FooterSocialIconName =
  | "instagram"
  | "facebook"
  | "youtube"
  | "whatsapp";
...
export const FOOTER_SOCIAL_LINKS: FooterSocialLink[] = [
  ...
  { id: "whatsapp", icon: "whatsapp", href: "#", label: "WhatsApp" },
];

export type FooterContactIconName = "phone" | "whatsapp" | "mail";
...
export const FOOTER_LEGAL_NAME = "Milagros Incensos Litúrgicos Ltda.";
